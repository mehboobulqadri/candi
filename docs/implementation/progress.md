...
| 01-v0.1 | 05-benchmarks-both-backends | committed | 2b99a96 — budget gate uses reader_peak (<200 MB); full_pass_peak ~295 MB documented FAIL vs MuPDF store ceiling, not gated; PR #10 pending |
