...
Current position: 01-v0.1/08-search-abstraction committed; next:
`01-v0.1/09-candi-tui`.
...
| 01-v0.1 | 08-search-abstraction | committed | 9c7e0f1 — lazy SearchSession over Document, case-insensitive per-page scan, cursor wrap, 15 tests |
